...
import RM_Contracts = require("ReleaseManagement/Core/Contracts");
...
class releasedEnvironment {
    ...
    preapproval_list: Array<String>;
    postapproval_list: Array<String>;
    level: number = 0;
...
class Dependency {
    ...
    level: number;
    constructor(environmentName, level)
    {
...
function CalculateLevel(dependentEnvironmentName): Dependency {
...
function DrawStraightConnection(sourceX: any, sourceY: any, targetX: any, targetY: any)
{
...
function DrawCurvedConnection(sourceX: any, sourceY: any, targetX: any, targetY: any, controlPointX: any, controlPointY: any, radius: any )
{
    canvas = document.getElementById("connectionCanvas");
    context = canvas.getContext("2d");
    context.beginPath();
...
function ConnectNodes() {
    ...
    while (releasedEnvironmentCount < totalNoOfReleasedEnvironments) {
        ...
        if (ReleasedEnvironments[releasedEnvironmentCount].dependencies[dependencyCount].environmentName != "ReleaseStarted" && ReleasedEnvironments[releasedEnvironmentCount].dependencies.length != 0) {  //Check if the environment is not on the first level
